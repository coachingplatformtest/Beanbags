...
BEGIN
  ...
  (fsu_nd_game, fsu_id, 3, 'player_prop', 'Peter Mauldin Passing Yards',   'QB', 'Over 215.5',  -115, 'Under 215.5', -105),
  (fsu_nd_game, fsu_id, 3, 'player_prop', 'Peter Mauldin Passing TDs',     'QB', 'Over 1.5',   +135, 'Under 1.5',  -165),
